...
namespace L2DatEncDec.Tools
{
    ...
    public class L2EncDec
    {
        ...
        public static void SystemPatcher()
        {
            ...
            string fname_libdll = Path.Combine(LmUtils.GlobalUtilities.GetStartDirectory(false), @"l2encdec\libgmp-3.dll");
            ...
            try
            {
                ...
                if (l2exe_file != "")
                {
                    ...
                    if (Program.main_form.selectedDatVersion >= L2DatEncDec.Parsers.DatVersion.ChaoticThrone1)
                    {
